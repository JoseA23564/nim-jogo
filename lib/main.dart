...
class _TelaJogoNimState extends State<TelaJogoNim> {
  String nomeJogador = "JOSÉ ANTONIO RAMOS BARRETO GOMES";
  String raJogador = "1431432312026";
  int totalPalitos = 0;
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextField(
              ...
              keyboardType: TextInputType.number,
              decoration:
                  InputDecoration(labelText: 'VALOR MÁXIMO PARA PALITOS'),
              onChanged: (value) {
